    ...
    <div className="mq-page mq-projects">
      <div className="mq-project-topbar">
        <figure className="mq-generated-panel mq-github-panel">
          <img src="/assets/portfolio/ui-github-panel-clean.png" alt="Pixel GitHub contribution board" />
        </figure>
...
function AchievementsMemory({ section }: { section: PortfolioSection }) {
  return (
    <div className="mq-page mq-achievements">
      <div className="mq-achievement-hero">
        <div className="mq-achievement-crest" aria-hidden="true">
          <span className="mq-crest-mark">XP</span>
          <strong>Proof</strong>
          <small>rank, research, product, and craft</small>
        </div>
